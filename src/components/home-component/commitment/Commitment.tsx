      ...
      <div className="col-span-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mt-12 md:mt-0">
          <div className="text-center md:text-start">
            ...
            <p className="mt-4">
              Quy trình khai thác nghiêm ngặt, chỉ những tổ yến hình thành, được
              nuôi dưỡng trên 6 tháng mới được thu hoạch về Nhà Vui.
            </p>
          </div>
          <div className="text-center md:text-start">
            <h5 className={classes.title}>CAO CẤP</h5>
            <p className="mt-4">
              Yến Nhà Vui tự tin với gu thẩm mỹ tinh tế cùng một sản phẩm được
              nâng niu bởi những người thợ lành nghề sẽ truyền tải được những
              thông điệp của sự trân trọng, tình thân.
            </p>
          </div>
          <div className="text-center md:text-start">
            <h5 className={classes.title}>UY TÍN</h5>
            <p className="mt-4">
              Hơn 10 năm hoạt động trong nghề, chữ TÂM và TÍN luôn đồng hành
              cùng Yến Nhà Vui để mang đến những sản phẩm tốt nhất, sang trọng
              nhất với chất lượng thượng hạng.
            </p>
          </div>
        </div>
      </div>
