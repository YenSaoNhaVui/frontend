        ...
        <div className="md:min-h-screen container m-auto pt-12 md:pt-0 px-8 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-4 justify-center">
            ...
            <p style={{ color: colors["secondary-3"] }}>
              ...
              phẩm Yến sào tự nhiên, không qua bất kỳ quá trình chế biến hay xử
              lý hóa học nào, để đảm bảo giữ nguyên toàn bộ giá trị dinh dưỡng
              và hương vị đặc biệt của loại thực phẩm này.
            </p>
