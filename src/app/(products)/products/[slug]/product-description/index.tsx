...
export default function ProductDescription() {
  return (
    <section className="lg:max-w-[920px] mx-auto mt-[34px] text-primary-1-7">
      <div className="border border-primary-1-7 mb-[56px]">
        ...
        <div className="grid grid-cols-2 border-b border-primary-1-7">
          ...
          <div className="flex flex-col justify-center p-5">
            Tổ yến tinh chế nguyên chất – cao cấp 30g (3 miếng) 01 hũ thuỷ tinh
            kỷ tử 01 hũ thuỷ tinh táo đỏ 01 hũ thuỷ tinh đông trùng hạ thảo 01
            hộp đường phèn
          </div>
        </div>
        <div className="grid grid-cols-2 border-b border-primary-1-7">
      ...
      <div className="mb-[56px]">
        <p className="text-body-md-semibold">
          Quy định đổi trả của Yến Nhà Vui
        </p>
        <div className="border-t border-solid border-[#204F4F] my-2" />
        <p className="text-body-sm-normal">
      ...
      <div className="mb-[56px]">
        <h3 className="text-center">SẢN PHẨM TƯƠNG TỰ</h3>
